...
//           onClick={() =>
//             downloadFile(
//               `hhttps://ethio-federal-prison-hr-o4rx.vercel.app${file}`,
//               `attachment-${index + 1}`
//             )
//           }
//         >
        ...
        <div className='flex flex-col gap-2  bg-gray-100 rounded-lg shadow-md'>
          {attachments.map((file, index) => (
            <button
              ...
              onClick={() =>
                downloadFile(
                  `https://ethio-federal-prison-hr-o4rx.vercel.app${file}`,
                  `attachment-${index + 1}`
                )
              }
            >
    ...
    <>
      ...
      <div className='flex justify-end gap-2 mb-3'>
        ...
        <CSVLink
          ...
          className='bg-green-300 rounded-md px-4 text-center text-md no-underline'
        >
          CSV
        </CSVLink>
        <button
      ...
      <div
        id='printable-table'
        className='overflow-x-auto bg-white shadow-md rounded-xl'
      >
        <table className='min-w-full divide-y divide-gray-200'>
          <thead className='bg-gray-50'>
            {table.getHeaderGroups().map((headerGroup) => (
