...
type CenterFormProps = {
  initialData?: Center | NewCenter;
  onSubmit: (data: NewCenter) => void;
  onClose: () => void;
  title: string;
};
...
const CenterForm: React.FC<CenterFormProps> = ({
  ...
  const [formData, setFormData] = React.useState<NewCenter>(initialData);
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-96 relative">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <select
              name="isHeadquarters"
              value={formData.isHeadquarters ? "true" : "false"}
              onChange={handleChange}
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            >
