...
const EmployeeListTable: React.FC = () => {
  const navigate = useNavigate();
  const [employees, setEmployees] = useState<IEmployeeListTable[]>([]);
  const employeesQuery = useAllEmployees();
  ...
  const pdfFunction = () => {
    ...
    handleDownloadPDF(MyDocument, 'employee_list.pdf');
  };
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen px-2 sm:px-4 lg:px-6">
        ...
        <div className="flex justify-end gap-2 mb-3">
          ...
          <CSVLink data={csvData} filename={"employee_list.csv"} className="bg-green-300 rounded-md px-4 text-center text-md no-underline">
            CSV
          </CSVLink>
