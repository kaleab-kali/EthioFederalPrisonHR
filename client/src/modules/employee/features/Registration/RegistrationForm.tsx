...
const RegistrationForm: React.FC = () => {
  ...
  const steps = [
    t("registrationForm.steps.civilMilitarySelection"),
    t("registrationForm.steps.basicInfo"),
    t("registrationForm.steps.workInfo"),
    t("registrationForm.steps.maritalEmergencyContact"),
  ];
          ...
          <div className="flex justify-between mt-6">
            {step > 0 && (
              <button
                ...
                onClick={prevStep}
              >
                {t("registrationForm.buttons.back")}
              </button>
            )}
            {step < 3 ? (
              <button
                ...
                disabled={!isValid}
              >
                {t("registrationForm.buttons.next")}
              </button>
            ) : (
              <button
                type="submit"
              ...
              >
                {submitForm.isPending
                  ? t("registrationForm.buttons.submitting")
